...
namespace LearningEnumerationTypesAndCollectionsV0._9._1
{
    public partial class Form1 : Form
    {
        //created program which create 2 decks (1 is random with one to ten cards, second is default deck with 52 cards ALWAYS, program lets us shuffle cards and transfer cards between themself)
        ...
        private void moveToDeck2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Wybierz kartę do przerzucenia.");
            }
            RedrawDeck(1);
            RedrawDeck(2);
        }
